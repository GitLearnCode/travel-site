	...
	var stickyHeader = function () {
		...
		_createClass(stickyHeader, [{
			...
			value: function createHeaderWaypoint() {
				var that = this;
				new Waypoint({
					// the first item in a jquery array refears to the native DOM element.
	...
	var Modal = function () {
		...
		_createClass(Modal, [{
			...
			value: function events() {
				...
				// close modal on pushing the escape key
			...
			value: function openModal() {
				...
				// return false to stop the default behaviour of the a element.
				return false;
			}
		}, {
			key: 'closeModal',
